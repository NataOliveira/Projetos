...
//MOSTRAR NA TELA OPÇÃO DE MODELOS DE CARROS
	...
	printf (" \nSelecione : ");
	scanf ("%i", &chose);
// COMANDO QUE VAI RECEBER VALOR E ARMAZENAR NA VARIÁVEL ''CHOSE'' E VERIÁVEL ''CARRO'' RECEBER VALOR
	switch (chose) {
...
//variável ''carroslect'' recebe valor da variável ''carros'' e mostra na tela
	  carroslect = carro;
		printf("\nValor : %.2f", carroslect);
//MOSTRA NA TELA OPÇÕES DE PAGAMENTO
...
//APLICA DESCONTO DE 10%
		...
		printf("\nValor Final do Veículo com desconto : %.2f\n", carroslect);
//RECEBER INFORMAÇÕES DO CLIENTE PARA EMISSÃO DA NOTA
		printf("\n\n**********INSIRA SEUS DADOS**********\n");
...
//MOSTRA OPÇÕES DE PARCELAMENTO E VALORES COM JUROS
...
//FAZ O CALCULO DO JUROS NA OPÇÃO SELCIONADA ACIMA
		switch (opjuros) {
			case 1:
